...
Generated: `2026-09-09T23:21:14.442535+08:00`
...
| Metric | Result |
|---|---:|
| Extraction Pass Rate | 0.6250 |
| Normalized Pass Rate | 0.6000 |
| Kind Accuracy | 0.8182 (36/44) |
| Subject Accuracy | 0.8043 (37/46) |
| Perspective Accuracy | 0.8478 (39/46) |
| Canonical/Custom Accuracy | 0.7273 (24/33) |
| Event Type Accuracy | 0.6667 (6/9) |
| Pattern Metric Accuracy | 0.5556 (5/9) |
| Multi-claim Completeness | 0.1667 |
| Forbidden Claim Violation Rate | 0.0750 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| stable_fact | 8 | 0.8750 | 0.8750 | 0.8750 (7/8) | 0.8750 (7/8) | 0.8750 (7/8) | 0.8750 (7/8) | n/a (0/0) | n/a (0/0) | n/a | 0.0000 |
| preference | 8 | 0.8750 | 0.7500 | 1.0000 (8/8) | 1.0000 (8/8) | 1.0000 (8/8) | 0.7500 (6/8) | n/a (0/0) | n/a (0/0) | n/a | 0.0000 |
| interaction_event | 8 | 0.6250 | 0.6250 | 0.8750 (7/8) | 0.7500 (6/8) | 0.8750 (7/8) | 0.0000 (0/1) | 0.8571 (6/7) | n/a (0/0) | n/a | 0.0000 |
| interaction_pattern | 8 | 0.5000 | 0.5000 | 0.6250 (5/8) | 0.7500 (6/8) | 0.7500 (6/8) | 0.6250 (5/8) | n/a (0/0) | 0.5714 (4/7) | n/a | 0.1250 |
| boundary | 8 | 0.2500 | 0.2500 | 0.7500 (9/12) | 0.7143 (10/14) | 0.7857 (11/14) | 0.7500 (6/8) | 0.0000 (0/2) | 0.5000 (1/2) | 0.1667 | 0.2500 |

## Case diagnostics

| case_id | group | Extraction | Normalization | first failure | short reason |
|---|---|---|---|---|---|
| sf_001 | stable_fact | FAIL | FAIL | EXTRACTION_SEMANTIC_LOSS | extraction:unmatched_expected=[0] fields=canonical_predicate,memory_kind,perspective,predicate_type,subject,value; normalization:unmatched_expected=[0] fields=canonical_predicate,memory_kind,perspective,predicate_type,subject,value |
...
| pref_006 | preference | PASS | PASS | - | Extraction and normalization satisfy all partial constraints. |
| pref_007 | preference | FAIL | FAIL | EXTRACTION_SEMANTIC_LOSS | extraction:unmatched_expected=[0] fields=canonical_predicate; normalization:unmatched_expected=[0] fields=canonical_predicate |
| pref_008 | preference | PASS | FAIL | NORMALIZATION_CANONICAL_MAPPING_ERROR | normalization:unmatched_expected=[0] fields=canonical_predicate,predicate_type |
...
| event_008 | interaction_event | FAIL | FAIL | EXTRACTION_SEMANTIC_LOSS | extraction:unmatched_expected=[0] fields=memory_kind,perspective,predicate_type,subject; normalization:unmatched_expected=[0] fields=memory_kind,perspective,predicate_type,subject |
...
| pattern_004 | interaction_pattern | FAIL | FAIL | FORBIDDEN_CLAIM_EMITTED | extraction:unmatched_expected=[0] fields=predicate_type forbidden_hits=1; normalization:unmatched_expected=[0] fields=predicate_type forbidden_hits=1 |
...
| pattern_007 | interaction_pattern | FAIL | FAIL | EXTRACTION_SEMANTIC_LOSS | extraction:unmatched_expected=[0] fields=canonical_predicate,memory_kind,metric,perspective,predicate_type,source,subject; normalization:unmatched_expected=[0] fields=canonical_predicate,memory_kind,metric,perspective,predicate_type,source,subject |
| pattern_008 | interaction_pattern | PASS | PASS | - | Extraction and normalization satisfy all partial constraints. |
| bd_001 | boundary | FAIL | FAIL | FORBIDDEN_CLAIM_EMITTED | extraction:forbidden_hits=1; normalization:forbidden_hits=1 |
...
| bd_004 | boundary | FAIL | FAIL | EXTRACTION_SUBJECT_ERROR | extraction:unmatched_expected=[1] fields=subject; normalization:unmatched_expected=[1] fields=subject |
| bd_005 | boundary | PASS | PASS | - | Extraction and normalization satisfy all partial constraints. |
| bd_006 | boundary | FAIL | FAIL | FORBIDDEN_CLAIM_EMITTED | extraction:unmatched_expected=[0] fields=canonical_predicate,memory_kind forbidden_hits=1; normalization:unmatched_expected=[0] fields=canonical_predicate,memory_kind forbidden_hits=1 |
...
| bd_008 | boundary | FAIL | FAIL | EXTRACTION_ATOMICITY_ERROR | extraction:unmatched_expected=[0, 1] fields=canonical_predicate,memory_kind,metric,perspective,subject; normalization:unmatched_expected=[0, 1] fields=canonical_predicate,memory_kind,metric,perspective,subject |

## Diagnostic conclusion

- Extraction-drift candidates: `8`
- Normalization-only drift candidates: `1`
...
| EXTRACTION_SEMANTIC_LOSS | 6 |
| EXTRACTION_SUBJECT_ERROR | 2 |
| FORBIDDEN_CLAIM_EMITTED | 3 |
| MULTI_CLAIM_MISSING | 1 |
| NORMALIZATION_CANONICAL_MAPPING_ERROR | 1 |
...
| pattern_004 | FAIL | FAIL | FORBIDDEN_CLAIM_EMITTED |
...
- Strong calls: `0`
- Failures: `0`
- Prompt tokens: `267262`
- Completion tokens: `12937`
- P50 latency: `2200.28 ms`
- P95 latency: `3444.63 ms`
